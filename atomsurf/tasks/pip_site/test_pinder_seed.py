...
from pl_model import PINDERModule_seed
from data_loader import PINDERDataModule,PINDERDataModule_resgraph_onfly
...
def main(cfg=None):
    ...
    # init datamodule
    datamodule = PINDERDataModule_resgraph_onfly(cfg) #PINDERDataModule

    # init model
    model = PINDERModule_seed(cfg)
